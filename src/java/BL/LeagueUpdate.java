 ...
 * @author VtG
 */
public class LeagueUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dbPool.isInitErr()) {
            ...
            msg = "<h2>Upravit ligu - DB pool exception:</h2>" + dbPool.getInitErrTxt();
            ...
            if (msg == null) {
                ...
                try {
                    ...
                    pstmt = conn.prepareStatement("UPDATE leagues SET lname=?,lshort=? WHERE lid=?");
                    pstmt.setString(1, request.getParameter("plname"));
                    pstmt.setString(2, request.getParameter("plshort"));                    
                    pstmt.setInt(3, Integer.parseInt(request.getParameter("plid")));
            ...
            response.sendRedirect(response.encodeRedirectURL("league-list.jsp?ls=true"));
