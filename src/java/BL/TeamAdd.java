...
public class TeamAdd extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dbPool.isInitErr()) {
            ...
            msg = "<h2>Smazat tým - DB pool exception:</h2>" + dbPool.getInitErrTxt();
            ...
            if (msg == null) {
                ...
                try {
                    ...
                    pstmt = conn.prepareStatement("DELETE FROM teams WHERE tid=?");
            ...
            response.sendRedirect(response.encodeRedirectURL("team-list.jsp"));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dbPool.isInitErr()) {
            ...
            msg = "<h2>Přidat tým - DB pool exception:</h2>" + dbPool.getInitErrTxt();
            ...
            //provedeme kontrolu povinnych udaju a ziskame data z formulare
            if (request.getParameter("ptname") != null) {
            } else {
                msg = "Název týmu musí být zadán !";
            }
            ...
            if (msg == null) {
                ...
                try {
                    ...
                    conn.setAutoCommit(false);
                    //nyni zapiseme nove hodnoty do matches
                    pstmt = conn.prepareStatement("INSERT INTO teams (tname) VALUES (?)");
                    pstmt.setString(1, request.getParameter("ptname"));
                    pstmt.executeUpdate();
                    pstmt.close();
            ...
            //presmerovani na stranku kde probehne info o probehlem pozadavku
            session.setAttribute("s_msg", msg);
            response.sendRedirect(response.encodeRedirectURL("team-add.jsp?recsaved=true"));
