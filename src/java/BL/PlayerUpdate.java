...
public class PlayerUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dbPool.isInitErr()) {
            ...
            msg = "<h2>Upravit hráče - DB pool exception:</h2>" + dbPool.getInitErrTxt();
            ...
            if (msg == null) {
                ...
                try {
                    ...
                    pstmt = conn.prepareStatement("UPDATE players SET pname=?,psurname=?,pgender=? WHERE pid=?");
                    ...
                    pstmt.setInt(4, Integer.parseInt(request.getParameter("ppid")));
