...
-- Started on 2017-09-17 20:34:58 CEST
...
--
-- TOC entry 2312 (class 1262 OID 111048)
-- Name: BL-JBL; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "BL-JBL" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'cs_CZ.UTF-8' LC_CTYPE = 'cs_CZ.UTF-8';


ALTER DATABASE "BL-JBL" OWNER TO postgres;
...
--
-- TOC entry 193 (class 1255 OID 111049)
...
--
-- TOC entry 200 (class 1255 OID 111050)
...
--
-- TOC entry 201 (class 1255 OID 111051)
...
--
-- TOC entry 202 (class 1255 OID 111052)
...
--
-- TOC entry 203 (class 1255 OID 111053)
...
--
-- TOC entry 204 (class 1255 OID 111054)
...
--
-- TOC entry 205 (class 1255 OID 111055)
...
--
-- TOC entry 206 (class 1255 OID 111056)
...
--
-- TOC entry 207 (class 1255 OID 111057)
...
--
-- TOC entry 208 (class 1255 OID 111058)
...
--
-- TOC entry 209 (class 1255 OID 111059)
...
--
-- TOC entry 210 (class 1255 OID 111060)
-- Name: getteamwlt_gd(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION getteamwlt_gd(mid integer, tid integer) RETURNS character varying
    LANGUAGE plpgsql
    AS $_$DECLARE
t1points double precision;
t2points double precision;
BEGIN
  SELECT INTO t1points pointstotal FROM endresults WHERE emid=$1 AND etid=$2;
  SELECT INTO t2points pointstotal FROM endresults WHERE emid=$1 AND etid<>$2;
  
  IF t1points > t2points THEN RETURN 'W';
  ELSIF t1points < t2points THEN RETURN 'L';
  ELSE RETURN 'T';  
  END IF;
END;
$_$;
...
ALTER FUNCTION public.getteamwlt_gd(mid integer, tid integer) OWNER TO postgres;

--
-- TOC entry 2325 (class 0 OID 0)
-- Dependencies: 210
-- Name: FUNCTION getteamwlt_gd(mid integer, tid integer); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION getteamwlt_gd(mid integer, tid integer) IS 'Vrati W v pripade vyhry L v pripade prohry a T pri remize pro zadany zapas a team';


--
-- TOC entry 211 (class 1255 OID 111061)
...
--
-- TOC entry 212 (class 1255 OID 111062)
...
--
-- TOC entry 213 (class 1255 OID 111063)
...
--
-- TOC entry 214 (class 1255 OID 111064)
...
--
-- TOC entry 170 (class 1259 OID 111065)
...
--
-- TOC entry 171 (class 1259 OID 111068)
...
--
-- TOC entry 172 (class 1259 OID 111076)
...
--
-- TOC entry 173 (class 1259 OID 111082)
...
--
-- TOC entry 174 (class 1259 OID 111084)
...
--
-- TOC entry 175 (class 1259 OID 111088)
...
--
-- TOC entry 176 (class 1259 OID 111091)
...
--
-- TOC entry 177 (class 1259 OID 111093)
...
--
-- TOC entry 178 (class 1259 OID 111099)
...
--
-- TOC entry 179 (class 1259 OID 111101)
...
--
-- TOC entry 180 (class 1259 OID 111106)
...
--
-- TOC entry 181 (class 1259 OID 111108)
...
--
-- TOC entry 182 (class 1259 OID 111112)
...
--
-- TOC entry 183 (class 1259 OID 111114)
...
--
-- TOC entry 184 (class 1259 OID 111118)
...
--
-- TOC entry 185 (class 1259 OID 111120)
...
--
-- TOC entry 2169 (class 2606 OID 140407)
...
--
-- TOC entry 2171 (class 2606 OID 140409)
...
--
-- TOC entry 2173 (class 2606 OID 140411)
...
--
-- TOC entry 2175 (class 2606 OID 140413)
...
--
-- TOC entry 2177 (class 2606 OID 140415)
...
--
-- TOC entry 2179 (class 2606 OID 140417)
...
--
-- TOC entry 2180 (class 2606 OID 140418)
...
--
-- TOC entry 2181 (class 2606 OID 140423)
...
--
-- TOC entry 2182 (class 2606 OID 140428)
...
--
-- TOC entry 2183 (class 2606 OID 140433)
...
--
-- TOC entry 2184 (class 2606 OID 140438)
...
--
-- TOC entry 2185 (class 2606 OID 140443)
...
--
-- TOC entry 2186 (class 2606 OID 140448)
...
--
-- TOC entry 2187 (class 2606 OID 140453)
...
--
-- TOC entry 2188 (class 2606 OID 140458)
...
--
-- TOC entry 2189 (class 2606 OID 140463)
...
--
-- TOC entry 2190 (class 2606 OID 140468)
...
--
-- TOC entry 2191 (class 2606 OID 140473)
...
--
-- TOC entry 2192 (class 2606 OID 140478)
...
--
-- TOC entry 2193 (class 2606 OID 140483)
...
--
-- TOC entry 2194 (class 2606 OID 140488)
...
--
-- TOC entry 2195 (class 2606 OID 140493)
...
--
-- TOC entry 2196 (class 2606 OID 140498)
...
--
-- TOC entry 2197 (class 2606 OID 140503)
...
--
-- TOC entry 2198 (class 2606 OID 140508)
...
--
-- TOC entry 2199 (class 2606 OID 140513)
...
--
-- TOC entry 2200 (class 2606 OID 140518)
...
-- Completed on 2017-09-17 20:34:58 CEST
